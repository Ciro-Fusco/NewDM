...
public class TicketDaoTest {
    ...
    public void getTicketCorretto() throws DatabaseException, ProdottoException, ElencaException, ScontrinoException, TicketNotFoundException {
        ...
        s.save();
        Ticket t = new Ticket("Gigi Cirillo","ggg","Via giardinetti n 10","Bevanda","acqua San BENEDETTO","0001121",340432l,s.getId(),s.getData(),1000000000001l);
        t.setProblema("non è buono");
        t.save();
        Ticket ticket = TicketDao.getTicket(t.getDataApertura(),t.getCf(),Long.parseLong(t.getNumeroDiSerie()));
    ...
    public void getTicketNonTrovato() throws DatabaseException, ProdottoException, ElencaException, ScontrinoException, TicketNotFoundException {
        ...
        s.addProdotto(1000000000001L);
        s.save();
        Ticket t = new Ticket("Gigi Cirillo","ggg","Via giardinetti n 10","Bevanda","acqua San BENEDETTO","22",340432l,s.getId(),s.getData(),1000000000001l);
        t.setProblema("non è buono");
