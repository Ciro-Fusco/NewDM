...
Windows.setText(findWindowsObject('Object Repository/TipoProdottoAssistenzaText'), 'Computer')

Windows.click(findWindowsObject('CodProdottoAssistenza'))

Windows.setText(findWindowsObject('CodProdottoAssistenzaText'), '1000000000001')

Windows.click(findWindowsObject('NumSerieAssistenza'))

Windows.setText(findWindowsObject('NumSerieAssistenzaText'), 'X1ay07')

Windows.click(findWindowsObject('DataScontrinoAssistenza'))

Windows.setText(findWindowsObject('DataScontrinoAssistenzaText'), '12/12/2020')

Windows.click(findWindowsObject('NumScontrinoAssistenza'))

Windows.setText(findWindowsObject('NumScontrinoAssistenzaText'), '1')

Windows.click(findWindowsObject('CodFiscaleAssistenza'))

Windows.setText(findWindowsObject('CodFiscaleAssistenzaText'), 'CRLFNC00R00G000Y')

Windows.click(findWindowsObject('Object Repository/AvantiAssistenza'))

def text = Windows.getText(findWindowsObject('AssistenzaDettagliProblemaLabel'))

assert text == 'Assistenza - Dettagli problema'
